...
/**
 * Remove a link without removing what it points at. A Windows junction is a
 * directory to `unlink` — which fails with EISDIR — and a `rmdir` to remove;
 * a POSIX symlink is the other way round.
 */
