...
```bash
npm install
npm run package                              # produces blindspot-0.2.0.vsix
...
v0.2 — the model, the report, the panel, the CLI and the hook all work, and
it installs from a `.vsix` and is usable. See [`CHANGELOG.md`](CHANGELOG.md).
